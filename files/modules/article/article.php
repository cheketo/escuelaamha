<?php
    ...
    if($Article->SectionData['public']=="N")
	   if(!$ArticleID || !($Article->HavePermission($Admin->ProfileID,$Admin->GetGroups()) || $Admin->ProfileID<10) || !$Article->IsActive()){header("location:../principal/main.php");die;}
    ...
    function ShowComments($Comment,$ArticleID,$Admin="",$Data)
    {
        ...
        $Reply  = !is_object($Admin) && ($Comment['parent_id'] >0 || $Data['reply']=='N')? '': ' - <div class="BlueCyan reply" style="display:inline-block;cursor:pointer;" comment="'.$Comment['comment_id'].'">Responder</div>';
        ...
        if($Comment['parent_id']==0 && is_object($Admin)){
            ...
            <div>
                ...
                <div class="ListBody Georgia14px" style="padding:0px;" id="MainComment">
                    ...
                    <div class="CommentContent" style="width:100%;" id="CommentContainer0">
                        ...
                        <div class="Left CommentBody Center" style="width:100%;margin-top:10px;">
                            No hay comentarios sobre este art&iacute;culo.
                        </div>
                        <?php } ?>
